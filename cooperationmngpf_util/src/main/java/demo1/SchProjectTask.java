...
public class SchProjectTask implements Serializable {
	...
	public String toString() {
		return "SchProjectTask [id=" + id + ", recordId=" + recordId + ", uniqueId=" + uniqueId + ", parentId="
				+ parentId + ", name=" + name + ", level=" + level + ", duration=" + duration + ", durationTimeUnit="
				+ durationTimeUnit + ", startTime=" + startTime + ", finishTime=" + finishTime + ", percentageComplete="
				+ percentageComplete + ", predecessors=" + predecessors + ", ProId=" + ProId + "]";
	}
}
